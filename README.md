...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/neir04rkl/ayayx)  
...
* **务必替换所有的5f1f2f3a-91ef-4804-9483-9d938ab48db2为部署时设置的AUUID**  
...
* 端口：443
* 默认UUID：5f1f2f3a-91ef-4804-9483-9d938ab48db2
* 加密：none
* 传输协议：ws
* 伪装类型：none
* 路径：/5f1f2f3a-91ef-4804-9483-9d938ab48db2-vless // 默认vless使用/$uuid-vless，vmess使用/$uuid-vmess
* 底层传输安全：tls
```
</details>
...
* 客户端下载: https://github.com/p4gefau1t/trojan-go/releases
{
    ...
    "remote_port": 443,
    "password": [
        "5f1f2f3a-91ef-4804-9483-9d938ab48db2"
    ],
    "websocket": {
        "enabled": true,
        "path": "/5f1f2f3a-91ef-4804-9483-9d938ab48db2-trojan",
...
* 插件选项: tls;host=appname.herokuapp.com;path=/5f1f2f3a-91ef-4804-9483-9d938ab48db2-ss
```
</details>
